    ...
    <footer className="footer">
        ...
        <div className="footer-content">
          <div className="footer-links">
            <div className="footer-column">
              ...
              <ul>
                ...
                <li><a href="/affiliate">Trở thành đối tác</a></li>
                <li><a href="/careers">Làm việc với chúng tôi</a></li>
            ...
            <div className="footer-column">
              ...
              <ul>
                ...
                <li><a href="/find-guests">Tìm khách</a></li>
                <li><a href="/inspire">Truyền cảm hứng</a></li>
                <li><a href="/invite-friends">Mời bạn bè</a></li>
              </ul>
            </div>
            ...
            <div className="footer-column">
              ...
              <ul>
                <li><a href="/help">Cần trợ giúp?</a></li>
          ...
          <div className="footer-social">
            ...
            <div className="social-icons">
              ...
              <a href="https://tiktok.com" className="social-icon tiktok">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="footer-lower">
        <div className="footer-legal">
          ...
          <a href="/privacy">Tuyên bố Bảo mật</a>
          <span className="separator">|</span>
